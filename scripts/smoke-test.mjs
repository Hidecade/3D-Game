...
g.damageEnemy(g.state.boss,300);assert.equal(g.state.mode,'victory');assert.equal(elements.get('overlay').hidden,true);
...
for(let i=1;i<=95;i++)g.frame(48+i*40);
...
for(let i=96;i<=102;i++)g.frame(48+i*40);
