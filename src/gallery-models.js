...
export const galleryModels=[
 {name:'自機のドラゴン ＋ 騎手',description:'青い翼と3本の金橙色の角を持つ小型の竜に、金髪の騎手が乗る。',create(){const model=createDragon({referenceStyle:true});model.add(createRider());return model;},animate:animateDragon},
